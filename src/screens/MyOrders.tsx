/*TODO:START HERE
*   Button In header for on and off duty(DONE)
*   Change theme of app(DONE)
*   Authentication
*   My Orders Details
*   OrderDetails
*    - Create 2-3 fake Completed Orders in bakend
*    - map to track location
*    - Change Order Details
*    - Actions - Update Order - delivery time - customer rating - Picked
*   connect with user app
